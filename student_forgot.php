<?php
// student_forgot.php (updated - design matched with other pages)
// PHPMailer/SMTP support logic unchanged - only UI/design added to match site
        ...
        if (!$row) {
            ...
            if ($row !== false) {
                ...
                if ($emailAvailable && $mail_sent) {
                    ...
                    if ($dev_show_link) {
                        $success .= "<br><small>Reset link (dev only): <a href=\"" . htmlspecialchars($reset_link, ENT_QUOTES, 'UTF-8') . "\">" . htmlspecialchars($reset_link, ENT_QUOTES, 'UTF-8') . "</a></small>";
                    } else {
...
<body>
  ...
  <div class="container">
    <div class="auth-card">
      ...
      <p class="lead">Enter your School ID or registered email. We'll send a link to reset your password.</p>
